...
@Entity
@Table(name = "sipsa_datos_semanales")
public class SipsaDatoSemanal {
    ...
    public LocalDateTime getFechaInicioSemana() { return fechaInicioSemana; }
    public void setFechaInicioSemana(LocalDateTime fechaInicioSemana) { this.fechaInicioSemana = fechaInicioSemana; }
